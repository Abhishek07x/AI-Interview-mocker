  ...
  return (
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        {/* 🎨 Left Side: Super Attractive Tech Animated Hero */}
        <section className="relative flex h-48 items-end bg-slate-950 lg:col-span-5 lg:h-full xl:col-span-6 overflow-hidden border-r border-slate-900">
          ...
          <div className="hidden lg:relative lg:block lg:p-16 text-white z-10 w-full">
            ...
            {/* Floating Feature Card (ShadCN style inspired interface) */}
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6 bg-slate-50">
          <div className="max-w-xl lg:max-w-3xl flex flex-col items-center justify-center w-full">
            
            <div className="relative -mt-16 block lg:hidden mb-8">
              <Image src="/logo.svg" width={140} height={80} alt="logo" />
            </div>

            <div className="shadow-2xl rounded-2xl overflow-hidden p-2 bg-white border border-gray-100">
              <SignUp />
            </div>
